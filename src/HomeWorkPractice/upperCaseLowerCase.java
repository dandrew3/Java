    ...
    public static void main(String[] args) {
       /* Ask user to enter a password
        ...
        Good Luck !*/
                ...
                if (lowCase == password || upperCase == password) {
                    System.out.println("Your password is not acceptable");
                }else if (password.charAt(0) ==  upperCase.charAt(0)&& password.charAt(0) !=  lowCase.charAt(0) && upperCase.charAt(lastIndex) == lowCase.charAt(lastIndex)) {
                    System.out.println("Your password is strong");
                }else if (password.charAt(0) == lowCase.charAt(0) && password.charAt(0) != upperCase.charAt(0) && password.charAt(lastIndex) == upperCase.charAt(lastIndex)) {
